...
Игнорирует все элементы, отправляемые источником `поток`, и передает только сигналы о завершении или об ошибке.
...
Игнорирует отправляемые значения, реагирует на завершение `поток`-а. 
